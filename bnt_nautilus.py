...
import os
import numpy as np
from bnt_mcmc_Simple import bnt_core
import pyccl as ccl
...
bnt_std = bnt_core(nz_dt,NL_recipe=NL_recipe,A_IA=AIAfid,
...
bnt_fid = bnt_core(nz_dt,NL_recipe=NL_recipe,A_IA=AIAfid,
                   dz1 = mu_dz[0],dz2 = mu_dz[1],
                   dz3 = mu_dz[2],dz4 = mu_dz[3],
                   dz5 = mu_dz[4],dz6 = mu_dz[5],
                   dz7 = mu_dz[6],dz8 = mu_dz[7],
...
bnt_tsc = bnt_core(nz_dt,Omega_m = 0.2,NL_recipe=NL_recipe,A_IA=AIAfid,
                   dz1 = mu_dz[0],dz2 = mu_dz[1],
                   dz3 = mu_dz[2],dz4 = mu_dz[3],
                   dz5 = mu_dz[4],dz6 = mu_dz[5],
                   dz7 = mu_dz[6],dz8 = mu_dz[7],
...
elif NL_recipe == 'mead2016' or 'mead':
...
def loglike_cosmo(param_dict):
    bnt_the = bnt_core(nz_dt,**param_dict,ell_arr=ell_arr,dz_mean = mu_dz,
                       NL_recipe='mead',dzmode='additive',m_bias=True)
